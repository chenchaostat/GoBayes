...
The package is designed for workflows where the computational engine is deployed separately, for example on a local server, an internal institutional server, or a cloud container service. The R package focuses on user-facing configuration, request submission, authentication, result conversion, and formatted output.
